...
export default function StudentDatabaseApp() {
  ...
  const lastUpdatedString = useMemo(() => {
    ...
    if (currentSection === 'profile') {
       Object.values(groupedProfileStudents).forEach(group => { list = list.concat(group); });
    } else if (currentSection === 'plan') {
       Object.values(groupedPlanStudents).forEach(group => { list = list.concat(group); });
    } else if (currentSection === 'lulus') {
       Object.values(groupedLulusStudents).forEach(group => { list = list.concat(group.students); });
    } else {
