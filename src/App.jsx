            ...
            {isMbk ? (
               <>
                 <div className="flex items-center justify-center gap-2 mb-3">
                   ...
                   <span className="font-bold text-slate-700 dark:text-slate-300 tracking-wide font-mono">{student.ic}</span>
                 </div>
                 <div className={`bg-indigo-50 dark:bg-indigo-900/30 p-2 rounded-lg text-sm font-medium text-indigo-900 dark:text-indigo-200 mb-2`}>
          ...
          {isMbk && (
            <div className={`mt-2 w-full pt-4 border-t flex flex-col gap-2 ${isDarkMode ? 'border-slate-700' : 'border-slate-100'}`}>
              <button 
                ...
                className={`flex-1 flex items-center justify-center gap-2 text-sm font-bold text-white py-2.5 rounded-xl transition-all shadow-sm ${student.docLink ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-slate-300 dark:bg-slate-700 cursor-not-allowed text-slate-500'}`}
              >
              ...
              {student.mbkType === 'OKU' && student.qrCodeUrl && (
                <button 
                  ...
                  className={`flex items-center justify-center gap-2 text-sm font-bold py-2.5 rounded-xl transition-all shadow-sm border ${isDarkMode ? 'bg-slate-800 text-white border-slate-600 hover:bg-slate-700' : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-50'}`}
                >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className={`rounded-full p-1 flex items-center text-xs font-bold shadow-inner ${isDarkMode ? 'bg-slate-800' : 'bg-slate-100/80 backdrop-blur-sm'}`}>
                <button 
                  ...
                  className={`px-4 py-1.5 rounded-full transition-all duration-300 flex items-center gap-1.5 ${role === 'admin' ? (isDarkMode ? 'bg-slate-700 text-indigo-400 shadow-sm' : 'bg-white shadow-sm text-indigo-600') : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200'}`}
                >
                ...
                <button 
                  ...
                  className={`px-4 py-1.5 rounded-full transition-all duration-300 ${role === 'user' ? (isDarkMode ? 'bg-slate-700 text-indigo-400 shadow-sm' : 'bg-white shadow-sm text-indigo-600') : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200'}`}
                >
                  User
                </button>
              </div>
            ...
            <div className={`flex p-1.5 rounded-2xl shadow-sm border gap-1 min-w-max transition-colors ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
              {[
                ...
                <button 
                  ...
                  className={`px-5 py-2.5 text-sm font-bold rounded-xl transition-all duration-200 whitespace-nowrap ${currentSection === tab.id ? 'bg-indigo-600 text-white shadow-md shadow-indigo-200 dark:shadow-none' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'}`}
                >
                  {tab.label}
                </button>
              ))}
             ...
             {selectedStudentForProgress ? (
               <div className={`rounded-3xl border shadow-sm overflow-hidden transition-colors ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
                 ...
                 <div className={`border-b p-6 flex flex-col md:flex-row justify-between items-center gap-4 transition-colors ${isDarkMode ? 'bg-slate-900/50 border-slate-700' : 'bg-slate-50 border-slate-200'}`}>
                    ...
                    <button onClick={() => setSelectedStudentForProgress(null)} className={`px-4 py-2 border rounded-xl text-sm font-bold shadow-sm transition-colors ${isDarkMode ? 'bg-slate-800 border-slate-600 text-slate-200 hover:bg-slate-700' : 'bg-white border-slate-300 hover:bg-slate-50'}`}>
                      Change Student
                    </button>
                 </div>
                 ...
                 <div className={`flex border-b transition-colors ${isDarkMode ? 'border-slate-700' : 'border-slate-200'}`}>
                    {(selectedStudentForProgress.subject === 'Pemulihan BM' || selectedStudentForProgress.subject === 'Pemulihan BM dan Matematik') && (
                      <button 
                        ...
                        className={`flex-1 py-4 text-center font-bold text-sm transition-colors ${progressSubject === 'BM' ? 'text-indigo-600 border-b-2 border-indigo-600' : (isDarkMode ? 'bg-slate-800 text-slate-400 hover:bg-slate-700' : 'bg-slate-50 text-slate-500 hover:bg-slate-100')}`}
                      >
                        Bahasa Melayu
                      </button>
                    )}
                    {(selectedStudentForProgress.subject === 'Pemulihan Matematik' || selectedStudentForProgress.subject === 'Pemulihan BM dan Matematik') && (
                      <button 
                        ...
                        className={`flex-1 py-4 text-center font-bold text-sm transition-colors ${progressSubject === 'MATH' ? 'text-emerald-600 border-b-2 border-emerald-600' : (isDarkMode ? 'bg-slate-800 text-slate-400 hover:bg-slate-700' : 'bg-slate-50 text-slate-500 hover:bg-slate-100')}`}
                      >
                        Matematik
                      </button>
                    )}
             ...
             <div className={`flex flex-col lg:flex-row gap-4 mb-8 justify-between items-start lg:items-center p-4 rounded-2xl shadow-sm border transition-colors ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-100'}`}>
                ...
                <div className="flex gap-3 w-full lg:w-auto items-center ml-auto">
                   {(role === 'admin' && (currentSection === 'profile' || currentSection === 'mbk')) && (
                     <button 
                       onClick={openAdd} 
                       className="flex-1 lg:flex-none flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 text-white px-5 py-2.5 rounded-xl shadow-md font-bold text-sm"
                     >
                   ...
                   <button 
                     ...
                     className={`flex-1 lg:flex-none flex items-center justify-center gap-2 text-sm font-bold px-5 py-2.5 border rounded-xl transition-colors ${isDarkMode ? 'bg-slate-800 border-slate-600 text-slate-300 hover:bg-slate-700' : 'bg-white border-slate-200 text-slate-600 hover:bg-slate-50'}`}
                   >
               ...
               <div className="space-y-10">
                  ...
                  {currentSection === 'profile' && Object.keys(groupedProfileStudents).sort().map(className => {
                    ...
                    return (
                      <div key={className} className={`rounded-3xl border shadow-sm overflow-hidden ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
                        <div className={`px-8 py-4 border-b ${style.border} flex justify-between items-center ${isDarkMode ? 'bg-slate-800' : 'bg-white'}`}>
                  ...
                  {currentSection === 'plan' && Object.keys(groupedPlanStudents).sort().map(yearGrp => (
                    <div key={yearGrp} className={`rounded-3xl border shadow-sm overflow-hidden ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
                      <div className={`px-8 py-4 border-b flex justify-between items-center ${isDarkMode ? 'bg-blue-900/30 border-blue-800' : 'bg-blue-50 border-blue-100'}`}>
                  ...
                  {currentSection === 'lulus' && Object.keys(groupedLulusStudents).sort().map(yearGrp => (
                    <div key={yearGrp} className={`rounded-3xl border shadow-sm overflow-hidden ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
                      <div className={`px-8 py-4 border-b flex justify-between items-center ${isDarkMode ? 'bg-purple-900/30 border-purple-800' : 'bg-purple-50 border-purple-100'}`}>
         ...
         {[
           ...
           { id: 'progress', l: 'Prog', i: TrendingUp }
            ...
            <button 
              ...
              className={`flex flex-col items-center justify-center w-full py-3 transition-colors ${currentSection === t.id ? (isDarkMode ? 'text-indigo-400 bg-indigo-900/20' : 'text-indigo-600 bg-indigo-50/50') : (isDarkMode ? 'text-slate-500 hover:text-slate-300' : 'text-slate-400 hover:text-slate-600')}`}
            >
          ...
          {moveConfirmation.newStatus === 'Lulus' && (
            <div className={`w-full text-left p-3 rounded-lg border ${isDarkMode ? 'bg-slate-700 border-slate-600' : 'bg-gray-50 border-gray-200'}`}>
              ...
              <div className="flex items-center gap-2">
                ...
                <input 
                  type="date" 
                  className={`bg-transparent border-none focus:ring-0 text-sm font-medium w-full p-0 style-color-scheme-dark ${isDarkMode ? 'text-white' : 'text-gray-900'}`} 
                  value={moveDate} 
          ...
          <form onSubmit={saveNote} className="space-y-3">
            <div>
              ...
              <input 
                type="date" 
                required 
                className={`w-full px-3 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 style-color-scheme-dark ${isDarkMode ? 'bg-slate-700 border-slate-600 text-white' : 'bg-white border-gray-300'}`} 
                value={noteForm.date} 
            ...
            <div>
              ...
              <textarea 
                ...
                className={`w-full px-3 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 ${isDarkMode ? 'bg-slate-700 border-slate-600 text-white placeholder-slate-400' : 'bg-white border-gray-300'}`} 
                value={noteForm.text} 
         ...
         <div className="space-y-6">
           ...
           <div>
             ...
             <div className="flex gap-2">
               <input 
                 type="date" 
                 className={`flex-1 px-3 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 style-color-scheme-dark ${isDarkMode ? 'bg-slate-700 border-slate-600 text-white' : 'bg-white border-gray-300'}`} 
                 value={attendanceDate} 
                 onChange={e=>setAttendanceDate(e.target.value)}
               />
               <button 
                 onClick={()=>markAttendance('present')} 
                 className={`flex items-center justify-center gap-1 px-4 py-2 font-bold rounded-xl transition-colors ${isDarkMode ? 'bg-emerald-900/50 text-emerald-400 hover:bg-emerald-800/50' : 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200'}`}
               >
                 <Check size={16}/> Present
               </button>
               <button 
                 onClick={()=>markAttendance('absent')} 
                 className={`flex items-center justify-center gap-1 px-4 py-2 font-bold rounded-xl transition-colors ${isDarkMode ? 'bg-red-900/50 text-red-400 hover:bg-red-800/50' : 'bg-red-100 text-red-700 hover:bg-red-200'}`}
               >
                 <X size={16}/> Absent
               </button>
             </div>
        ...
        <form onSubmit={handleSave} className="space-y-4 text-sm">
          {!editingId && (
            <div className={`flex p-1 rounded-xl mb-4 ${isDarkMode ? 'bg-slate-900' : 'bg-slate-100'}`}>
              <button 
                ...
                className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${formData.program==='pemulihan'?(isDarkMode ? 'bg-slate-700 shadow-sm text-indigo-400' : 'bg-white shadow-sm text-indigo-600'):(isDarkMode ? 'text-slate-400 hover:text-slate-200' : 'text-slate-500 hover:text-slate-700')}`}
              >
                Profile Pemulihan
              </button>
              <button 
                ...
                className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${formData.program==='mbk'?(isDarkMode ? 'bg-slate-700 shadow-sm text-indigo-400' : 'bg-white shadow-sm text-indigo-600'):(isDarkMode ? 'text-slate-400 hover:text-slate-200' : 'text-slate-500 hover:text-slate-700')}`}
              >
                Murid MBK & OKU
              </button>
            </div>
          ...
          <div>
            ...
            <input 
              ...
              className={`w-full p-2.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 ${isDarkMode ? 'bg-slate-700 border-slate-600 text-white placeholder-slate-400' : 'bg-white border-gray-300'}`} 
              value={formData.name} 
          ...
          <div>
            ...
            <div className={`flex gap-6 p-2.5 border rounded-xl ${isDarkMode ? 'border-slate-700 bg-slate-800/50' : 'border-slate-200 bg-white'}`}>
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className={`text-sm ${isDarkMode ? 'text-white' : 'text-slate-700'}`}>Lelaki</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className={`text-sm ${isDarkMode ? 'text-white' : 'text-slate-700'}`}>Perempuan</span>
              </label>
            </div>
          </div>
            ...
            <>
              <div>
                ...
                <input 
                  ...
                  className={`w-full p-2.5 border rounded-xl font-mono text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 ${isDarkMode ? 'bg-slate-700 border-slate-600 text-white placeholder-slate-400' : 'bg-white border-gray-300'}`} 
                  value={formData.ic} 
              ...
              <div>
                ...
                <select 
                  className={`w-full p-2.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 ${isDarkMode ? 'bg-slate-700 border-slate-600 text-white' : 'bg-white border-gray-300'}`} 
            ...
            <>
              <div>
                ...
                <div className={`flex gap-6 p-2.5 border rounded-xl ${isDarkMode ? 'border-slate-700 bg-slate-800/50' : 'border-slate-200 bg-white'}`}>
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    <span className={`text-sm ${isDarkMode ? 'text-white' : 'text-slate-700'}`}>MBK (Tiada Kad)</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    <span className={`text-sm ${isDarkMode ? 'text-white' : 'text-slate-700'}`}>OKU (Ada Kad)</span>
                  </label>
                </div>
              </div>
              <div>
              ...
              {formData.mbkType === 'OKU' && (
                <div className={`p-4 border rounded-xl flex items-center justify-between ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-slate-50 border-slate-200'}`}>
                  <span className={`font-bold flex items-center gap-2 text-sm ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
          ...
          <div className="flex gap-3 pt-4">
            <button 
              ...
              className={`flex-1 py-3 text-sm font-bold rounded-xl transition-colors ${isDarkMode ? 'bg-slate-700 text-white hover:bg-slate-600' : 'bg-slate-100 text-slate-700 hover:bg-slate-200'}`}
            >
              Cancel
            </button>
            <button 
