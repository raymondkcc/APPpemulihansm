                      ...
                      <div className="flex flex-col items-center gap-2">
                        ...
                        {role === 'admin' && (
                           <div className="grid grid-cols-2 gap-1 w-[70px]">
                              ...
                              <button onClick={() => confirmDelete(student)} className="p-1 text-red-500 bg-red-50 rounded border border-red-100 shadow-sm flex items-center justify-center"><Trash2 size={12} /></button>
                           </div>
                        )}
                      </div>
